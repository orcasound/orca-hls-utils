...
class TestDataAvailabilityScenarios(unittest.TestCase):
    ...
    def create_mock_m3u8_content(self, num_segments=10, segment_duration=1.0):
        ...
        for i in range(num_segments):
            ...
            segment_mock.base_uri = (
                f"{self.stream_base}/hls/{self.mock_folders[0]}/"
            )
    ...
    def test_scenario_2_missing_middle_data(
        self,
        mock_ffmpeg,
        mock_download,
        mock_m3u8,
    ...
    @patch("orca_hls_utils.DateRangeHLSStream.scraper.download_from_url")
    @patch("orca_hls_utils.DateRangeHLSStream.ffmpeg.run")
    def test_scenario_3_missing_later_half(
        self,
        mock_ffmpeg,
        mock_download,
        mock_m3u8,
    ...
    @patch("orca_hls_utils.DateRangeHLSStream.scraper.download_from_url")
    @patch("orca_hls_utils.DateRangeHLSStream.ffmpeg.run")
    def test_scenario_5_full_data_available(
        self,
        mock_ffmpeg,
        mock_download,
        mock_m3u8,
    ...
    @patch("orca_hls_utils.DateRangeHLSStream.scraper.download_from_url")
    @patch("orca_hls_utils.DateRangeHLSStream.ffmpeg.run")
    def test_scenario_6_single_folder_insufficient_data(
        self,
        mock_ffmpeg,
        mock_download,
        mock_m3u8,
    ...
    @patch("orca_hls_utils.DateRangeHLSStream.scraper.download_from_url")
    @patch("orca_hls_utils.DateRangeHLSStream.ffmpeg.run")
    def test_scenario_7_intermittent_data_gaps(
        self,
        mock_ffmpeg,
        mock_download,
        mock_m3u8,
