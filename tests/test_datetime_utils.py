...
class TestDatetimeUtils(unittest.TestCase):
    ...
    def test_get_clip_name_from_unix_time(self):
        ...
        clipname, readable_datetime = datetime_utils.get_clip_name_from_unix_time(
    ...
    def test_get_difference_between_times_in_seconds(self):
        ...
        # Test normal case
        diff = datetime_utils.get_difference_between_times_in_seconds(unix_time1, unix_time2)
        expected_diff = -600.0  # unix_time1 is 600 seconds before unix_time2
        
        self.assertEqual(diff, expected_diff)
        print(f"Difference between {unix_time1} and {unix_time2}: {diff} seconds")
        
        # Test reverse order
        diff_reverse = datetime_utils.get_difference_between_times_in_seconds(unix_time2, unix_time1)
        expected_diff_reverse = 600.0  # unix_time2 is 600 seconds after unix_time1
        
        self.assertEqual(diff_reverse, expected_diff_reverse)
        print(f"Difference between {unix_time2} and {unix_time1}: {diff_reverse} seconds")
        
        # Test same time
        diff_same = datetime_utils.get_difference_between_times_in_seconds(unix_time1, unix_time1)
    ...
    def test_get_difference_between_times_string_inputs(self):
        ...
        self.assertEqual(diff, expected_diff)
        print(f"String inputs '{unix_time1}' and '{unix_time2}': {diff} seconds")
    ...
    def test_add_interval_to_unix_time(self):
        ...
        result = datetime_utils.add_interval_to_unix_time(unix_time, interval_seconds)
        
        # The function adds the interval and converts to Pacific time
        # The exact result depends on timezone conversion
        self.assertIsInstance(result, int)
        self.assertGreater(result, unix_time)  # Should be greater than original
        
        print(f"Original time: {unix_time}")
        print(f"Added {interval_seconds} seconds: {result}")
        
        # Test with different intervals
        result_1hour = datetime_utils.add_interval_to_unix_time(unix_time, 3600)  # 1 hour
        result_1day = datetime_utils.add_interval_to_unix_time(unix_time, 86400)  # 1 day
    ...
    def test_get_unix_time_from_datetime_utc(self):
        ...
        test_datetime = datetime(2023, 11, 14, 22, 13, 20)  # Matches our test unix time
        ...
        another_result = datetime_utils.get_unix_time_from_datetime_utc(another_datetime)
    ...
    def test_get_unix_time_from_datetime_utc_edge_cases(self):
        ...
        epoch_result = datetime_utils.get_unix_time_from_datetime_utc(epoch_datetime)
        ...
        future_result = datetime_utils.get_unix_time_from_datetime_utc(future_datetime)
        
        self.assertIsInstance(future_result, int)
        self.assertGreater(future_result, epoch_result)
        print(f"Future datetime {future_datetime} -> unix time {future_result}")
    ...
    def test_round_trip_conversions(self):
        ...
        new_unix = datetime_utils.add_interval_to_unix_time(original_unix, interval)
        
        # Calculate expected difference
        diff = datetime_utils.get_difference_between_times_in_seconds(new_unix, original_unix)
    ...
    def test_clip_name_consistency(self):
        ...
        clipname1, readable1 = datetime_utils.get_clip_name_from_unix_time(source_guid, unix_time)
        clipname2, readable2 = datetime_utils.get_clip_name_from_unix_time(source_guid, unix_time)
        ...
        clipname3, readable3 = datetime_utils.get_clip_name_from_unix_time(different_guid, unix_time)
